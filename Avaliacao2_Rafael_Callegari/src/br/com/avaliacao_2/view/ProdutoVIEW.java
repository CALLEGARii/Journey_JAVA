...
import br.com.avaliacao_2.ctr.FornecedorCTR;
...
public class ProdutoVIEW extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnPesquisarFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/avaliacao_2/view/imagens/pesquisar.png"))); // NOI18N
        ...
        btnPesquisarProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/avaliacao_2/view/imagens/pesquisar.png"))); // NOI18N
    ...
    private void gravar(){
        try{
            ...
            fornecedorDTO.setId_forn(Integer.parseInt(String.valueOf(
    ...
    private void liberaCampos(boolean a){
     ...
     private void preencheCamposProduto(int id_prod){
         ...
         try{
             ...
             if(rs.next()){
                 ...
                 modelo_jtl_consultar_fornecedor.setNumRows(0);
                 modelo_jtl_consultar_fornecedor.addRow(new Object[]{rs.getInt("id_forn"), rs.getString("nome_forn"),});
     ...
     private void preencheTabelaFornecedor(String nome_forn){
